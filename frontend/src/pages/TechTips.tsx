      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 mb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="group relative bg-white/20 backdrop-blur-md border border-white/30 text-gray-700 px-6 py-3 rounded-2xl font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-white/40 hover:text-blue-600"
          >
            <div className="flex items-center space-x-2">
              <Plus className="w-4 h-4 transition-transform duration-300 group-hover:rotate-90" />
              <span className="relative z-10">Submit Tip</span>
            </div>
